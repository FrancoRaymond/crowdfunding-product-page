    ...
    <div className='bg-white rounded-md sm:px-6 flex flex-col gap-3 w-[90%] mx-auto p-4 sm:p-6 mt-5'>
        ...
        <div className='py-7 px-5 border-2 border-gray-300 rounded-md flex flex-col gap-5'>
            <div className='flex flex-col items-start sm:flex-row sm:items-center sm:justify-between'>
                ...
                <button className='text-[#3cb4ab] font-semibold cursor-pointer'>Pledge $25 or more</button>
            </div>
            ...
            <div className='flex flex-col items-start sm:flex-row sm:items-center sm:justify-between'>
                ...
                <button className='bg-[#3cb4ab] hover:bg-[#157a74] text-white py-3 mt-3 sm:mt-0 px-5 rounded-3xl font-semibold cursor-pointer'>Select Reward</button>
            </div>
        </div>
        <div className='py-7 px-5 border-2 border-gray-300 rounded-md flex flex-col gap-5'>
            <div className='flex flex-col items-start sm:flex-row sm:items-center sm:justify-between'>
                <h3 className='font-bold'>Black edition Stand</h3>
                <button className='text-[#3cb4ab] font-semibold cursor-pointer'>Pledge $75 or more</button>
            </div>
            ...
            <div className='flex flex-col items-start sm:flex-row sm:items-center sm:justify-between'>
                ...
                <button className='bg-[#3cb4ab] hover:bg-[#157a74] text-white mt-3 sm:mt-0 py-3 px-5 rounded-3xl font-semibold cursor-pointer'>Select Reward</button>
            </div>
        </div>
        <div className='py-7 px-5 border-2 border-gray-300 rounded-md flex flex-col gap-5 relative'>
            ...
            <div className='flex flex-col items-start sm:flex-row sm:items-center sm:justify-between'>
                ...
                <button className='text-[#3cb4ab] font-semibold cursor-pointer'>Pledge $200 or more</button>
            </div>
